...
- **Búsqueda instantánea** — atajo `Ctrl + K`, filtrado en tiempo real
...
- **Animaciones** — slideIn, slideOut, bounce del balón, flip en los toggles
- **Responsive** — mobile-first, se adapta a cualquier pantalla
- **Accesibilidad** — roles ARIA, aria-live, keyboard navigation, prefers-reduced-motion
